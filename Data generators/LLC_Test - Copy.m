...
fea_dir = 'features/flickr_logos_27/LLC_test';                                                  % directory for saving final image features
...
% end
% 
% Bpath = ['dictionary/flickr_logos_27_SIFT_Kmeans_512.mat'];
% 
% load(Bpath);
...
%     feaPath = fullfile(fea_dir, database.cname{flabel}, [fname '.mat']);
%     
%  
%     fea = LLC_pooling(feaSet, B, pyramid, knn);
%     label = database.label(iter1);
% 
%     if ~isdir(fullfile(fea_dir, database.cname{flabel})),
%         mkdir(fullfile(fea_dir, database.cname{flabel}));
%     end      
